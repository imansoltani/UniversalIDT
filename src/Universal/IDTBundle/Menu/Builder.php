...
//                'label' => $this->container->get('translator')->trans('menu.navbar.calling_cards',[],'webpage')
            ));

        $menu->addChild('Rates', array(
                'route' => 'WebPage_main',
                'extras' => array('route_label' => 'rates'),
//                'label' => $this->container->get('translator')->trans('menu.navbar.rates',[],'webpage')
            ));

        $menu->addChild('Applications', array(
                'route' => 'WebPage_main',
                'extras' => array('route_label' => 'application'),
//                'label' => $this->container->get('translator')->trans('menu.navbar.application',[],'webpage')
            ));

        $menu->addChild('Basket', array(
                'route' => 'WebPage_main',
                'extras' => array('route_label' => 'basket'),
//                'label' => $this->container->get('translator')->trans('menu.navbar.basket',[],'webpage')
            ));

        $menu->addChild('Contact', array(
                'route' => 'WebPage_main',
                'extras' => array('route_label' => 'contact'),
//                'label' => $this->container->get('translator')->trans('menu.navbar.contact',[],'webpage')
            ));
